...
func (in *MetricsApi) DeepCopyInto(out *MetricsApi) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new MetricsApi.
func (in *MetricsApi) DeepCopy() *MetricsApi {
	if in == nil {
		return nil
	}
	out := new(MetricsApi)
